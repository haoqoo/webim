...
package com.jivesoftware.spark.managers
{
	...
	public class PresenceManager extends EventDispatcher {
		...
		{ label: "空闲中", shortName: Presence.SHOW_CHAT, icon: freeToChat, presence:Presence.SHOW_CHAT},
		{ label: "我在线上", shortName: "Available", icon: imAvailable, presence:null},
...
//		{ label: "On The Road", shortName: "On The Road", icon: onTheRoad, presence:Presence.SHOW_XA},
		{ label: "请勿打扰", shortName: Presence.SHOW_DND, icon: imDND, presence:Presence.SHOW_DND}
		]);
